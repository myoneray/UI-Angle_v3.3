...
ApplicationConfiguration.registerModule('app.elements');

'use strict';

ApplicationConfiguration.registerModule('app.extras');
'use strict';
...
ApplicationConfiguration.registerModule('app.locale');
'use strict';

ApplicationConfiguration.registerModule('app.mailbox');
'use strict';

ApplicationConfiguration.registerModule('app.maps');
(function() {
    'use strict';
...
ApplicationConfiguration.registerModule('app.panels');
(function() {
    'use strict';
...
ApplicationConfiguration.registerModule('app.widgets');
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            ...
            .state('app.blog-post', {
                url: '/blog/post',
                title: 'Post',
                templateUrl: 'modules/blog/views/blog-post.client.view.html',
                resolve: helper.resolveFor('angular-jqcloud')
            })
            .state('app.articles', {
                url: '/blog/articles',
                title: 'Articles',
                templateUrl: 'modules/blog/views/blog-articles.client.view.html',
                resolve: helper.resolveFor('datatables')
            })
            .state('app.article-view', {
                url: '/blog/article/:id',
                title: 'Article View',
                templateUrl: 'modules/blog/views/blog-article-view.client.view.html',
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            .state('app.chart-flot', {
                url: '/chart/flot',
                title: 'Chart Flot',
                templateUrl: 'modules/charts/views/chart-flot.client.view.html',
                resolve: helper.resolveFor('flot-chart', 'flot-chart-plugins')
            })
            .state('app.chart-radial', {
                url: '/chart/radial',
                title: 'Chart Radial',
                templateUrl: 'modules/charts/views/chart-radial.client.view.html',
                resolve: helper.resolveFor('classyloader', 'ui.knob', 'easypiechart')
            })
            .state('app.chart-js', {
                url: '/chart/chartjs',
                title: 'Chart JS',
                templateUrl: 'modules/charts/views/chart-js.client.view.html',
                resolve: helper.resolveFor('chartjs')
            })
            .state('app.chart-rickshaw', {
                url: '/chart/rickshaw',
                title: 'Chart Rickshaw',
                templateUrl: 'modules/charts/views/chart-rickshaw.client.view.html',
                resolve: helper.resolveFor('angular-rickshaw')
            })
            .state('app.chart-morris', {
                url: '/chart/morris',
                title: 'Chart Morris',
                templateUrl: 'modules/charts/views/chart-morris.client.view.html',
                resolve: helper.resolveFor('morris')
            })
            .state('app.chart-chartist', {
                url: '/chart/chartist',
                title: 'Chart Chartist',
                templateUrl: 'modules/charts/views/chart-chartist.client.view.html',
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            ...
            .state('app.dashboard_v2', {
                url: '/dashboard/v2',
                title: 'Dashboard v2',
                templateUrl: 'modules/dashboard/views/dashboard_v2.client.view.html',
            ...
            .state('app.dashboard_v3', {
                ...
                controllerAs: 'dash3',
                templateUrl: 'modules/dashboard/views/dashboard_v3.client.view.html',
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            .state('app.form-standard', {
                url: '/form/standard',
                title: 'Form Standard',
                templateUrl: 'modules/forms/views/form-standard.client.view.html'
            })
            .state('app.form-extended', {
                url: '/form/extended',
                title: 'Form Extended',
                templateUrl: 'modules/forms/views/form-extended.client.view.html',
            ...
            .state('app.form-validation', {
                ...
                templateUrl: 'modules/forms/views/form-validation.client.view.html',
            ...
            .state('app.form-parsley', {
                ...
                templateUrl: 'modules/forms/views/form-parsley.client.view.html',
                resolve: helper.resolveFor('parsley')
            })
            .state('app.form-wizard', {
                url: '/form/wizard',
                title: 'Form Wizard',
                templateUrl: 'modules/forms/views/form-wizard.client.view.html',
                resolve: helper.resolveFor('parsley')
            })
            .state('app.form-upload', {
                url: '/form/upload',
                title: 'Form upload',
                templateUrl: 'modules/forms/views/form-upload.client.view.html',
                resolve: helper.resolveFor('angularFileUpload', 'filestyle')
            })
            .state('app.form-xeditable', {
                url: '/form/xeditable',
                templateUrl: 'modules/forms/views/form-xeditable.client.view.html',
                resolve: helper.resolveFor('xeditable')
            })
            .state('app.form-imagecrop', {
                url: '/form/imagecrop',
                templateUrl: 'modules/forms/views/form-imagecrop.client.view.html',
                resolve: helper.resolveFor('ngImgCrop', 'filestyle')
            })
            .state('app.form-uiselect', {
                url: '/form/uiselect',
                templateUrl: 'modules/forms/views/form-uiselect.client.view.html',
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            .state('app.maps-google', {
                url: '/maps/google',
                title: 'Maps Google',
                templateUrl: 'modules/maps/views/maps-google.client.view.html',
                resolve: helper.resolveFor('loadGoogleMapsJS', function() {
                    return loadGoogleMaps();
                }, 'ui.map')
            })
            .state('app.maps-vector', {
                url: '/maps/vector',
                title: 'Maps Vector',
                templateUrl: 'modules/maps/views/maps-vector.client.view.html',
